<?php
/**
 * Template Name: Frauen Team Uri II
...
$mc_url       = 'https://matchcenter.ifv.ch/default.aspx?v=329&oid=7&lng=1&t=52691&a=re';
...
<div class="fc1m-page">
  ...
  <div class="fc1m-hero">
    <div class="fc1m-photo">
      <img src="<?php echo esc_url( $up . 'FrauenUri2_Web2526.jpg' ); ?>" alt="Frauen Team Uri II FC Schattdorf">
    </div>
    <div class="fc1m-herobar">
      <div class="fc1m-herobar__inner">
        <h1 class="fc1m-herobar__title">Frauen Team Uri II</h1>
      </div>
    </div>
  </div>
