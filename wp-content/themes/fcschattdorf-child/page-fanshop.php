...
$products = [
    [
        ...
        'price'       => 25.00,
        'image'       => 'flexifit.png',
        'sizes'       => ['Kids', 'S/M', 'L/XL', 'XL/XXL'],
        'description' => 'Hochwertiger Flexfit-Cap im FC Schattdorf Design. Schweissabsorbierendes Material, optimale Passform dank elastischem Stretch-Band.',
    ...
    [
        ...
        'image'       => 'retro.png',
        'sizes'       => [],
        'description' => 'Klassischer Retro-Cap mit FCS-Logo. One Size – universelle Passform durch verstellbaren Verschluss.',
        'category'    => 'Kopfbedeckung',
    ],
    [
        'id'          => 'beanie',
        ...
        'image'       => 'beanie.png',
        'sizes'       => [],
        'description' => 'Warme Beanie-Mütze im Vereinsdesign. Weiches Strickmaterial, ideal für kühle Spieltage.',
        'category'    => 'Kopfbedeckung',
    ],
    [
        'id'          => 'halsschlauch-rot',
        'name'        => 'Hals-Schlauch rot',
        'price'       => 15.00,
        'image'       => 'halsschlauch-rot.png',
        'sizes'       => [],
        'description' => 'Multifunktionaler Hals-Schlauch in Rot. Kann als Halswärmer, Mütze oder Stirnband getragen werden.',
        'category'    => 'Accessoires',
    ],
    [
        'id'          => 'halsschlauch-schwarz',
        'name'        => 'Hals-Schlauch schwarz',
        'price'       => 15.00,
        'image'       => 'halsschlauch-schwarz.png',
        'sizes'       => [],
        'description' => 'Multifunktionaler Hals-Schlauch in Schwarz. Kann als Halswärmer, Mütze oder Stirnband getragen werden.',
        'category'    => 'Accessoires',
    ],
    [
        'id'          => 'gymbag',
        ...
        'image'       => 'gymbag.png',
        'sizes'       => [],
        'description' => 'Leichter und robuster Gymbag mit FCS-Logo. Ideal für Training und Spieltag.',
        'category'    => 'Taschen',
    ],
    [
        'id'          => 'duschtuch',
        ...
        'image'       => 'duschtuch.png',
        'sizes'       => [],
        'description' => 'Grosses, saugfähiges Duschtuch im FC Schattdorf Design. Hochwertige Frottierqualität.',
        'category'    => 'Haushalt',
    ],
    [
        'id'          => 'wimpel',
        ...
        'image'       => 'wimpel.png',
        'sizes'       => [],
        'description' => 'Offizieller FC Schattdorf Wimpel. Perfekte Dekoration für Zimmer, Büro oder Fanraum.',
        'category'    => 'Dekoration',
    ],
    [
        'id'          => 'seidenschal',
        'name'        => 'Seidenschal',
        'price'       => 30.00,
        'image'       => 'seidenschal.png',
        'sizes'       => [],
        'description' => 'Eleganter Seidenschal mit FCS-Logo in den Vereinsfarben. Leicht, vielseitig und hochwertig.',
        'category'    => 'Accessoires',
    ],
    [
        'id'          => 'strickschal',
        'name'        => 'Strickschal',
        'price'       => 30.00,
        'image'       => 'strickschal.png',
        'sizes'       => [],
        'description' => 'Warmer Strickschal im FCS-Design. Ideal für kalte Winterspiele auf der Tribüne.',
        'category'    => 'Accessoires',
    ],
    [
        'id'          => 'knirps-rot',
        'name'        => 'Knirps rot',
        'price'       => 25.00,
        'image'       => 'knirps-rot-scaled.png',
        'sizes'       => [],
        'description' => 'Kompakter Taschenschirm in Vereinsrot mit automatischer Öffnungs- und Schliessfunktion.',
    ...
    [
        ...
        'name'        => 'Knirps schwarz',
        'price'       => 25.00,
        'image'       => 'knirps-schwarz-scaled.png',
        'sizes'       => [],
        'description' => 'Kompakter Taschenschirm in Schwarz mit automatischer Öffnungs- und Schliessfunktion.',
        'category'    => 'Regenschirme',
    ],
    [
        'id'          => 'schirm-rot',
        'name'        => 'Schirm rot',
        'price'       => 29.00,
        'image'       => 'schirm-rot-scaled.png',
        'sizes'       => [],
        'description' => 'Grosser Stockschirm in Vereinsrot – für Tribüne und Alltag. Robuste Konstruktion, angenehmer Griff.',
        'category'    => 'Regenschirme',
    ],
    [
        'id'          => 'schirm-schwarz',
        'name'        => 'Schirm schwarz',
        'price'       => 29.00,
        'image'       => 'schirm-schwarz-scaled.png',
        'sizes'       => [],
        'description' => 'Grosser Stockschirm in Schwarz – für Tribüne und Alltag. Robuste Konstruktion, angenehmer Griff.',
        'category'    => 'Regenschirme',
    ],
];
